...
tab1 <- read.table("/home/csalazar/Documentos/tesis/capitulo2/parte1/matsuo/results_silva_polishON_pct85_FILT_matsuo_final/polished_abundance_tab.tsv", 
                   sep = "\t", header = T)
head(tab1)
tabb <- tab1
...
dir.create("/mnt/raid2tb/bubble/tesis/capitulo2/Fig8")
png("/mnt/raid2tb/bubble/tesis/capitulo2/Fig8/FigS_matsuo_ill.png", res = 600, height = 20, width = 20, units = "cm")
q
dev.off()
...
dir.create("/mnt/raid2tb/bubble/tesis/capitulo2/Fig8")
png("/mnt/raid2tb/bubble/tesis/capitulo2/Fig8/Fig8_matsuo_ill.png", res = 600, height = 20, width = 20, units = "cm")
q
dev.off()
